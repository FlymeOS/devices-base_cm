...
.method public updatePrefNwTypeIfRequired()V
    ...
    invoke-virtual {p0, v7, v8}, Lcom/android/internal/telephony/ModemBindingPolicyHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    iget-object v8, p0, Lcom/android/internal/telephony/ModemBindingPolicyHandler;->mNwModeinSubIdTable:[I

    aget v8, v8, v0

    invoke-interface {v7, v8, v1}, Lcom/android/internal/telephony/CommandsInterface;->setPreferredNetworkType(ILandroid/os/Message;)V
