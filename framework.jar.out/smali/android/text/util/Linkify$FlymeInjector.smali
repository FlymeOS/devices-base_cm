.class Landroid/text/util/Linkify$FlymeInjector;
...
# static fields
.field static sMask:I

.field static sTextSpannable:Landroid/text/Spannable;
...
.method static final gatherLinksDateTime(Ljava/util/ArrayList;)V
    .locals 6
    ...
    sget v0, Landroid/text/util/Linkify$FlymeInjector;->sMask:I
    ...
    .line 660
    sget-object v1, Landroid/text/util/Linkify$FlymeInjector;->sTextSpannable:Landroid/text/Spannable;
...
.method static final gatherTelLinks(Ljava/util/ArrayList;Landroid/text/Spannable;)Z
    .locals 7
    ...
    .line 629
    :cond_0
    invoke-static {p0, p1}, Landroid/text/util/Linkify$FlymeInjector;->mzGatherTelLinks(Ljava/util/ArrayList;Landroid/text/Spannable;)V

    goto :goto_0
.end method

.method static final initFlymeExtFields(Landroid/text/Spannable;I)V
    .locals 0
    ...
    .prologue
    .line 648
    sput-object p0, Landroid/text/util/Linkify$FlymeInjector;->sTextSpannable:Landroid/text/Spannable;

    .line 649
    sput p1, Landroid/text/util/Linkify$FlymeInjector;->sMask:I

    .line 650
    return-void
.end method

.method private static final mzGatherTelLinks(Ljava/util/ArrayList;Landroid/text/Spannable;)V
    .locals 10
    .param p1, "s"    # Landroid/text/Spannable;
    .annotation system Ldalvik/annotation/Signature;
        value = {
