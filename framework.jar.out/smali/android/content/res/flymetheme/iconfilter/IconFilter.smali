...
.method private addColorLevelFilter(Landroid/content/res/flymetheme/iconfilter/bean/FilterConfigInfo$Filter;)V
    ...
    .line 224
    .restart local v0    # "colorLevelFilter":Landroid/content/res/flymetheme/iconfilter/filters/ColorLevelFilter;
    .restart local v6    # "colorChannel":Ljava/lang/String;
...
.method private addEdgeDetect(Landroid/content/res/flymetheme/iconfilter/bean/FilterConfigInfo$Filter;)V
    ...
    .line 270
    .restart local v2    # "edgeColor":Ljava/lang/String;
    .restart local v3    # "edgeFilter":Landroid/content/res/flymetheme/iconfilter/filters/EdgeFilter;
...
.method private addFilter(Landroid/content/res/flymetheme/iconfilter/bean/FilterConfigInfo$Filter;)V
    ...
    .line 140
    :sswitch_0
    const-string v2, "GradientMapping"
    ...
    :sswitch_data_0
    .sparse-switch
        -0x4efc04a2 -> :sswitch_0
        -0x3d6181ff -> :sswitch_2
        -0x193ba520 -> :sswitch_3
        0x11ca1 -> :sswitch_1
    .end sparse-switch
...
.method public filter(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    .line 61
    :try_start_0
    iget-boolean v4, p0, Landroid/content/res/flymetheme/iconfilter/IconFilter;->isLoaded:Z
    ...
    :cond_0
    iget-object v4, p0, Landroid/content/res/flymetheme/iconfilter/IconFilter;->mFilters:Ljava/util/List;
    ...
    check-cast v2, Landroid/content/res/flymetheme/iconfilter/filters/BaseFilter;

    .line 65
    .local v2, "filter":Landroid/content/res/flymetheme/iconfilter/filters/BaseFilter;
    invoke-virtual {v2, p1}, Landroid/content/res/flymetheme/iconfilter/filters/BaseFilter;->filter(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .end local v2    # "filter":Landroid/content/res/flymetheme/iconfilter/filters/BaseFilter;
    :cond_1
    move-object v0, p1
